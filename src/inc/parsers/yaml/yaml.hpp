...
[[nodiscard]] constexpr auto Entry::begin() noexcept {
  return impl::Iterator(entries_.begin());
}
[[nodiscard]] constexpr auto Entry::end() noexcept {
  return impl::Iterator(entries_.end());
}
[[nodiscard]] constexpr auto Entry::begin() const noexcept {
  return impl::ConstIterator(entries_.begin());
}
[[nodiscard]] constexpr auto Entry::end() const noexcept {
