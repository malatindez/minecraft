...
[[nodiscard]] uint32_t RandomUint32(
    uint32_t min = std::numeric_limits<uint32_t>::min(),
    uint32_t max = std::numeric_limits<uint32_t>::max());
[[nodiscard]] uint32_t RandomUint16(
    uint16_t min = std::numeric_limits<uint16_t>::min(),
    uint16_t max = std::numeric_limits<uint16_t>::max());
[[nodiscard]] int64_t RandomInt64(
    int64_t min = std::numeric_limits<int64_t>::min(),
    int64_t max = std::numeric_limits<int64_t>::max());
[[nodiscard]] int32_t RandomInt32(
    int32_t min = std::numeric_limits<int32_t>::min(),
    int32_t max = std::numeric_limits<int32_t>::max());
[[nodiscard]] int16_t RandomInt16(
    int16_t min = std::numeric_limits<int16_t>::min(),
    int16_t max = std::numeric_limits<int16_t>::max());

[[nodiscard]] int64_t RandomInteger(
    int64_t min = std::numeric_limits<int64_t>::min(),
    int64_t max = std::numeric_limits<int64_t>::max());

[[nodiscard]] uint64_t RandomUnsignedInteger(
    uint64_t min = std::numeric_limits<uint64_t>::min(),
    uint64_t max = std::numeric_limits<uint64_t>::max());

[[nodiscard]] size_t RandomSizeT(
...
[[nodiscard]] long double RandomLongDouble(
...
[[nodiscard]] constexpr double time_diff(
